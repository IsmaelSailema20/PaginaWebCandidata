...
try {
    ...
    $tablesToDelete = ['propuestas_categorias', 'propuestas', 'sugerencias', 'miembros', 'secciones_inicio', 'eventos_noticias', 'propuestas', 'votos', 'votaciones', 'sugerencias', 'settings']; // Reemplaza con los nombres de tus tablas
