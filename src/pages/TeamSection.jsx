...
const TeamSection = () => {
  ...
  return (
    <>
      <section
        className="relative w-full min-h-screen overflow-hidden  text-black py-16"
        style={{ backgroundColor, color: textColor }}
      >
        <div className="container mx-auto">
          <div className="mb-12 text-center">
            <div
              className=" bg-opacity-80 p-4 rounded-md inline-block"
              style={{ backgroundColor, color: textColor }}
            >
              <h1
              ...
              >
                ...
                quienes aportan su experiencia, pasión y compromiso para
                representar los intereses de todos. Juntos, podemos lograr un
                futuro donde cada persona tenga la oportunidad de crecer y
                desarrollarse.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center mb-12">
            ...
            <div className="w-full lg:w-1/2 p-4">
              ...
              <div className="flex space-x-4">
                ...
                <div className="flex w-full text-center items-center align-middle">
                  <button
                    className="bg-blue-600 text-white text-sm px-3 py-1  hover:bg-blue-400 hover:scale-x-105"
                    onClick={() => openModal(mainCandidate)}
                  >
                    Leer más
                  </button>
                </div>
              ...
              <div className="w-full lg:w-1/2 p-4">
                ...
                <div className="flex space-x-4">
                  ...
                  <div className="flex w-full text-center items-center align-middle">
                    <button
                      className="bg-blue-600 text-white text-sm px-3 py-1  hover:bg-blue-400 hover:scale-x-105"
                      onClick={() => openModal(secondCandidate)}
                    >
                      Leer más
                    </button>
                  </div>
