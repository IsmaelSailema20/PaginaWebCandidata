      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-8 text-center text-sm">
            ...
            <p className="mb-1 text-gray-300">
              Fundado en: {informacion["Fecha de fundación"]}
            </p>
            <p className="mb-1 text-gray-300">
              <strong>Misión:</strong> {informacion.Misión}
            </p>
            <p className="mb-1 text-gray-300">
              <strong>Visión:</strong> {informacion.Visión}
            </p>
            <p className="text-gray-300">
              <strong>Valores:</strong> {informacion.Valores}
            </p>
          </div>
        </div>
        <div className="text-center text-sm mt-8">
          <p className="text-gray-300">
            ...
            {informacion["Nombre del partido"]}. Todos los derechos reservados.
          </p>
        </div>
      </footer>
    </>
